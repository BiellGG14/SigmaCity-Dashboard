...
const equipe = [
  ...
  },
  {
    ...
    linkedin: "https://www.linkedin.com/in/mayara-cond%C3%A9-rocha-mur%C3%A7a-a4a8482ba/",
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.teamGrid}>
        {equipe.map((membro) => (
          <div key={membro.nome} className={`glass-panel animate-fade-in-up ${styles.memberCard}`}>
            <a href={membro.linkedin} target="_blank" rel="noreferrer" className={styles.imageContainer}>
              <div className={styles.imageBorder}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={membro.foto} alt={membro.nome} className={styles.memberPhoto} />
              </div>
            </a>
